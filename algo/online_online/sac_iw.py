...
class SAC_IW(object):
    ...
    def update_q_functions(self, state_batch, action_batch, reward_batch, nextstate_batch, not_done_batch, importance_weighting=None, writer=None):
        with torch.no_grad():
    ...
    def train(self, src_replay_buffer, tar_replay_buffer, batch_size=128, writer=None):
        ...
        q_loss_step = self.update_q_functions(src_state, src_action, src_reward, src_next_state, src_not_done, importance_weighting, writer)
