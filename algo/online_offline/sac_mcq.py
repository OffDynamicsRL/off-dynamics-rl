...
class SACMCQ(object):
    ...
    def train(self, src_replay_buffer, tar_replay_buffer, batch_size=128, writer=None):
        ...
        # target domain data with MCQ loss and source domain data with SAC loss
        tar_q_loss_step = self.update_mcq_q_functions(tar_state, tar_action, tar_reward, tar_next_state, tar_not_done, writer)
        src_q_loss_step = self.update_q_functions(src_state, src_action, src_reward, src_next_state, src_not_done, writer)
